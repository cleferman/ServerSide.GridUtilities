...
namespace ServerSide.GridUtilities.Tests
{
 ...
 public class FilterByTests
 {
  ...
  [Test]
  public void FilterBy_TextNotContains_Success()
  {
   var model = new FilterModel
   {
    FieldName = "Name",
    ...
    Conditions =
      [
          new Condition
                        {
                            FilterMethod = FilterMethod.NotContains,
                            Values = ["Student a"]
                        }
      ]
   };
  ...
  [Test]
  public void FilterBy_TextBlank_Success()
  {
   var model = new FilterModel
   {
    FieldName = "Name",
    ...
    Conditions =
       [
           new Condition
                        {
                            FilterMethod = FilterMethod.Blank,
                            Values = []
                        }
       ]
   };
  ...
  [Test]
  public void FilterBy_TextNotBlank_Success()
  {
   var model = new FilterModel
   {
    FieldName = "Name",
    ...
    Conditions =
       [
           new Condition
                        {
                            FilterMethod = FilterMethod.NotBlank,
                            Values = []
                        }
       ]
   };
  ...
  [Test]
  public void FilterBy_TextIn_Success()
  {
   var model = new FilterModel
   {
    FieldName = "Name",
  ...
  [Test]
  public void FilterBy_TextNotIn_Success()
  {
   var model = new FilterModel
   {
    FieldName = "Name",
    ...
    Conditions =
       [
           new Condition
                        {
                            FilterMethod = FilterMethod.NotIn,
                            Values = ["Student 1", "Student 2"]
                        }
       ]
   };
  ...
  [Test]
  public void FilterBy_NumberLessThan_Success()
  {
   var model = new FilterModel
   {
    FieldName = "Age",
